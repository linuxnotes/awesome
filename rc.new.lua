...
--vicious.register(batwidget, vicious.widgets.bat, "||  $1 $2 $3MB)||", 10, "BAT1")
...
for s = 1, screen.count() do
    ...
    --mywibox1[s] = awful.wibox({ position = "left", screen = s })
       -- -- Add widgets to the wibox - order matters
       -- mywibox1[s].widgets = {
       --         {
       --                 layout = awful.widget.layout.vertical.leftright
       --         },
       --         memwidget,
       --         s == 1 and mysystray or nil,
